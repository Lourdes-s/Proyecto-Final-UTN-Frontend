    ...
    return (
        <div className='header'>
            <div className='contact-container'>
                ...
                <Link className='photo-link' to = {'/contact/' + contact.id}><img src={contact.thumbnail ? contact.thumbnail : defaultImage} className="profile-picture" alt="foto de perfil" /></Link>
